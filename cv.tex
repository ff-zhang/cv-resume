...
\resumeSubheadingThree
  {Master of Science in Computer Science, University of Toronto}{Sept. 2025 -- June 2027}
  {}{}
...
\section{Technical Skills}
  \begin{itemize}[leftmargin=0.15in, label={}]
      ...
      \small\textbf{Languages} & \small{C++, C, Rust, C\#, Java, Python} \\
      \small\textbf{Frameworks} & \small{PyTest, PyTorch, TensorFlow, scikit-learn, NumPy, Pandas, SciPy, Matplotlib, MuJoCo, Eigen3} \\
      \small\textbf{Tools} & \small{Git, shell, ssh, Unix, tmux, CMake, Anaconda, Google Colab, QEMU, Jupyter, WSL, Slurm}
    \end{tabular}
  \end{itemize}
