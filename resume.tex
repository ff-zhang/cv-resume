...
\resumeSubheadingThree
  ...
  {Honours Bachelor of Science in Computer Science; Major in Mathematics}{\censor{3.96}/4.0 cGPA}
      ...
      Fields Undergraduate Summer Research Program (\$\censor{3 800}),
      Louis Savlov Scholarship in Sciences And Humanities (\$\censor{1 000}),
      Second Malcolm Wallace Scholarship (\$\censor{5 000}),
